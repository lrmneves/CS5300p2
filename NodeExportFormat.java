...
public class NodeExportFormat extends FileOutputFormat<IntWritable, Text> {
    
    //Describes how to get a NodeRecordWriter object.
    //Note the use of the Factory pattern
    public RecordWriter<IntWritable, Text> getRecordWriter(TaskAttemptContext ctxt) throws IOException, InterruptedException {
	...
	return new NodeExport(fileOut); // Now we can use that stream for our writer
    }
